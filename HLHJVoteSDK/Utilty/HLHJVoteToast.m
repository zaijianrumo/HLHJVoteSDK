...
+ (void)hsShowCenterWithText:(NSString *)text {
    [HLHJVoteToast hsShowCenterWithText:text duration:ToastDispalyDuration];
}
...
+ (void)hsShowCenterWithText:(NSString *)text duration:(CGFloat)duration {
    HLHJVoteToast *toast = [[HLHJVoteToast alloc] initWithText:text];
...
+ (void)hsShowTopWithText:(NSString *)text {
    [HLHJVoteToast hsShowTopWithText:text topOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowTopWithText:(NSString *)text duration:(CGFloat)duration {
    [HLHJVoteToast hsShowTopWithText:text topOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowTopWithText:(NSString *)text topOffset:(CGFloat)topOffset {
    [HLHJVoteToast hsShowTopWithText:text topOffset:topOffset duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text {
    [HLHJVoteToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:ToastDispalyDuration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text duration:(CGFloat)duration {
    [HLHJVoteToast hsShowBottomWithText:text bottomOffset:ToastSpace duration:duration];
}
...
+ (void)hsShowBottomWithText:(NSString *)text bottomOffset:(CGFloat)bottomOffset {
    [HLHJVoteToast hsShowBottomWithText:text bottomOffset:bottomOffset duration:ToastDispalyDuration];
}
