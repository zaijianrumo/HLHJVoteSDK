...
@implementation HLHJAlertViewTools

+ (HLHJAlertViewTools *)shareInstance {
    static HLHJAlertViewTools *tools = nil;
...
- (void)p_showAlertController:(NSString *)title
    ...
    // 下面两行代码 是修改 title颜色和字体的代码
      NSAttributedString *attributedMessage = [[NSAttributedString alloc] initWithString:message attributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15.0f], NSForegroundColorAttributeName:[UIColor redColor]}];
